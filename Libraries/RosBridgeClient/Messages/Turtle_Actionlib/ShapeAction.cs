...
namespace RosSharp.RosBridgeClient.Messages.Turtle_Actionlib
{
	...
	{
		[JsonIgnore]
		public const string RosMessageName = "turtle_actionlib/ShapeAction";
		...
		public ShapeAction()
		{
			action_goal = new ShapeActionGoal();
			action_result = new ShapeActionResult();
			action_feedback = new ShapeActionFeedback();
		}
	}
}
