...
{
	public class TFSubscriptionActionResult
	{
		[JsonIgnore]
		public const string RosMessageName = "tf2_web_republisher/TFSubscriptionActionResult";
		...
		public TFSubscriptionResult result;
