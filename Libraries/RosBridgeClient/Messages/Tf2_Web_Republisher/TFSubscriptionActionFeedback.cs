...
{
	public class TFSubscriptionActionFeedback
	{
		[JsonIgnore]
		public const string RosMessageName = "tf2_web_republisher/TFSubscriptionActionFeedback";
		...
		public TFSubscriptionFeedback feedback;
