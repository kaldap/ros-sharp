...
{
	public class SensorLevels
	{
		[JsonIgnore]
		public const string RosMessageName = "dynamic_reconfigure/SensorLevels";
		...
		public SensorLevels()
		{
			RECONFIGURE_CLOSE = new byte();
			RECONFIGURE_STOP = new byte();
			RECONFIGURE_RUNNING = new byte();
		}
	}
}
